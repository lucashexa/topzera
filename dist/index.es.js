import React__default, { useContext, createContext, useState, useEffect, createElement, useMemo, forwardRef, useRef } from 'react';
...
var Button = function Button(props) {
    ...
    var _useState = useState(false), _useState2 = slicedToArray(_useState, 2), viewList = _useState2[0], setViewList = _useState2[1];
    return createElement('div', { className: style["ct-container"] }, createElement('button', { onClick: click, className: classes }, children), combo ? createElement(aux, null, createElement('button', { onClick: function onClick() {
            setViewList(!viewList);
        }, className: classes.concat(' ' + style['ct-button--arrow']) }, 'v'), viewList ? createElement(aux, null, createElement('ul', { className: style['ct-button__list'] }, list.map(function (e) {
        return createElement('li', { onClick: listClick, className: classes.concat(' ' + style['ct-button--in-list']) }, e);
    }))) : null) : null);
};
Button.defaultProps = {
    type: 'secondary',
...
var Input = function Input(props) {
    ...
    return createElement(aux, null, createElement('div', { className: style$1["ct-input__container"] }, label ? createElement('p', { className: style$1["ct-input__label"] }, required ? createElement('span', { className: style$1["ct-input__label__required-indicator"] }, '* ') : null, label) : null, createElement('div', { className: style$1["ct-wrapper"] }, createElement('input', { list: suggestionsId, value: value, onChange: change, className: classes, type: type }), type === "search" ? createElement('img', { className: style$1["ct-input--search__icon"], src: '', alt: '' }) : null)), createElement('datalist', { id: suggestionsId }, suggestions.map(function (e, i) {
        var showElement = void 0;
        showElement = {
            label: suggestionLabel,
            value: suggestionValue
        };
        return createElement('option', { value: e['' + showElement.value], key: i }, e['' + showElement.label]);
    })));
};
Input.defaultProps = {
    type: "text",
...
var Textarea = function Textarea(props) {
    ...
    return createElement(aux, null, label ? createElement('p', { className: style$3["ct-textarea__label"] }, required ? createElement('span', { className: style$3["ct-textarea__label__required-indicator"] }, '* ') : null, label) : null, createElement('textarea', { className: classes, onChange: change, cols: '30', rows: rows }));
};
...
var Dropdown = function Dropdown(props) {
    ...
    return createElement('div', { className: style$4["ct-dropdown__container"] }, label ? createElement('p', { className: style$4["ct-dropdown__label"] }, required ? createElement('span', { className: style$4["ct-dropdown__label__required-indicator"] }, '* ') : null, label) : null, createElement('select', { className: classes, onChange: change }, options.map(function (e) {
        ...
        return createElement('option', { value: e.value }, e.label);
    })));
};
...
var App = function App(_ref) {
  ...
  function Table(_ref2) {
    ...
    var defaultColumn$$1 = useMemo(function () {
      return {
        minWidth: 90,
        width: 150,
        maxWidth: 400
    ...
    var IndeterminateCheckbox = forwardRef(function (_ref3, ref) {
      ...
      return createElement('input', _extends({ type: 'checkbox', ref: resolvedRef }, rest));
    });
          ...
          Cell: function Cell(_ref5) {
            ...
            return createElement(
              ...
              createElement(
                'label',
                null,
                createElement(IndeterminateCheckbox, row.getToggleRowSelectedProps())
              )
            );
          },
          Footer: function Footer() {
            return createElement(
              'div',
              null,
              createElement('label', { onClick: addUser })
            );
          }
        }]);
      });
            ...
            return createElement(
              ...
              headerGroup.headers.map(function (column) {
                return createElement(
                  ...
                  createElement('div', _extends({}, column.getResizerProps(), {
                    className: style$5['resizer']
                  })),
                  createElement(
                    'span',
                    null,
                    column.isSorted ? column.isSortedDesc ? createElement('img', { src: arrow, height: 12, style: downArrow }) : createElement('img', { src: arrow, height: 12, style: upArrow }) : ''
                  )
                );
              })
            );
            ...
            return createElement(
              ...
              group.headers.map(function (column) {
                return createElement(
                  ...
                  createElement(Dropdown, { required: true, options: selectOptions, change: function change(e) {
  ...
  return createElement(
    ...
    createElement(Table, { columns: columns, data: data })
  );
};
...
var ContextInformation = function ContextInformation(_ref) {
    ...
    //Form starts invalid
    var _useState = useState(false), _useState2 = slicedToArray(_useState, 2), validateForm = _useState2[0], setValidateForm = _useState2[1];
...
var Form = function Form(props) {
    ...
    try {
        var _useContext = useContext(ContextInformation), setValidateForm = _useContext.setValidateForm;
...
var FormRow = function FormRow(props) {
    ...
    return createElement(aux, null, title ? createElement('p', { className: style$7['ct-form__row__title'] }, title) : null, createElement('div', { style: viewRatio, className: classes }, children));
};
...
var Collapsible = function Collapsible(props) {
    ...
    return createElement('div', { className: style$8["ct-collapsible__wrapper"] }, createElement('input', { id: 'collapsible', className: style$8["ct-collapsible__toggle"], type: 'checkbox', defaultChecked: defaultChecked }), createElement('label', { htmlFor: 'collapsible', className: style$8["ct-collapsible__toggle__label"] }, label), createElement('div', { className: style$8["ct-collapsible__content"] }, children));
};
...
var Row = function Row(props) {
    ...
    return createElement(aux, null, title ? createElement('p', { className: style$9['ct-row__title'] }, title) : null, createElement('div', { style: viewProportions, className: classes }, children));
};
Row.defaultProps = {
    children: null,
    height: "100%"
...
var Footer = function Footer(props) {
    ...
    return createElement('div', { className: style$a['ct-footer'] }, children);
};
Footer.defaultProps = {
    children: null
};
...
var Container = function Container(props) {
    ...
    return createElement('div', { style: proportions, className: style$b['ct-container'] }, children);
};
